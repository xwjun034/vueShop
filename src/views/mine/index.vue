<template>
    <div class="page">
        <subHeader title="个人中心" :isBack="false" />
        <div class="user-info-wrap">
             <div class="head"><img :src="head?head:require('@/assets/images/user/my/default-head.png')"/></div>
        ...
        <div class="menu-list-wrap">
            ...
            <div class='btn' @click="isLogin?outLogin():goPage('/login')" >{{isLogin?'退出':'登录/注册'}}</div>
        </div>
    </div>
</template>
<script>
...
<style lang="less">
   .user-info-wrap{width:100%;height:2.8rem;background-image:url("~@/assets/images/user/my/mybg.png");background-size:100%;background-repeat:no-repeat;background-position: top;margin-top:0.8rem;position: relative;z-index:1;}
